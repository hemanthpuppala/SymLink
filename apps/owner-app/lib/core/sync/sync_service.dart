...
class SyncService extends ChangeNotifier {
  ...
  void _connect() {
    ...
    _socket?.on('verification:created', (data) {
      print('[SyncService] Verification created: $data');
      _verificationController.add(Map<String, dynamic>.from(data));
    });

    _socket?.on('verification:updated', (data) {
      print('[SyncService] Verification updated: $data');
      _verificationController.add(Map<String, dynamic>.from(data));
    });
