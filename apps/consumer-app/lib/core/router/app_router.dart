...
class AppRouter {
  ...
  static int _getTabIndex(String path) {
    ...
    return 0; // Home and others default to 0
  }
      ...
      ShellRoute(
        ...
        routes: [
          GoRoute(
            path: '/home',
            name: 'home',
            pageBuilder: (context, state) => _buildTabPage(const HomeScreen(), state),
          ),
          GoRoute(
            path: '/map',
            name: 'map',
            pageBuilder: (context, state) => _buildTabPage(const MapScreen(), state),
          ),
          GoRoute(
            path: '/plants/:id',
            name: 'plant-details',
  ...
  void _setupSyncListener() {
    ...
    _syncMessageSub = SyncService.instance.onNewMessage.listen((data) {
      ...
      if (conversationId == widget.conversationId && message != null && mounted) {
        ...
        if (message['senderType'] == 'consumer') {
          return;
        }
                ...
                : _messages.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          // Consumer app: Teal for sent messages, light grey for received
                          const myBubbleColor = Color(0xFF009688); // Teal
